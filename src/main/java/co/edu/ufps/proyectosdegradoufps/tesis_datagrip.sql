...
CREATE TABLE comites (
    id SERIAL PRIMARY KEY,
    programa_codigo VARCHAR(20) NOT NULL UNIQUE,
    nombre VARCHAR(200) NOT NULL,
    fecha_creacion DATE,
    FOREIGN KEY (programa_codigo) REFERENCES programas(codigo)
);
...
COMMENT ON TABLE tipos_proyecto IS 'Catálogo de tipos según Acuerdo 065/1996: INVESTIGACION y EXTENSION';
COMMENT ON TABLE modalidades_proyecto IS 'Catálogo de 7 modalidades según estatuto UFPS: 3 de Investigación y 4 de Extensión';
